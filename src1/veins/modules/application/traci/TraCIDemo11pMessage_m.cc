...
const char * TraCIDemo11pMessage::getMyData() const
{
    return this->myData.c_str();
}

void TraCIDemo11pMessage::setMyData(const char * myData)
{
    this->myData = myData;
}
...
int TraCIDemo11pMessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='m' && strcmp(fieldName, "myData")==0) return base+1;
...
std::string TraCIDemo11pMessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 1: return oppstring2string(pp->getMyData());
...
bool TraCIDemo11pMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 1: pp->setMyData((value)); return true;
